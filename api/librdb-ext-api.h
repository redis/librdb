...
typedef struct RdbxToRespConf {
    ...
    /* dstRedisVersion is relevant only if supportRestore is set. It is required
     * to verify that the version of Redis that will eventually will consume RESP
     * output of this parser is aligned with the version of the source RDB file.
     * Otherwise, RESTORE won't be honored and higher level commands will be
     * generated by the parser instead */
