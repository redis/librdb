...
#define RDB_TYPE_HASH_TMPL_LP       29        /* Hinted hash (v15): self-contained (DUMP): [fields_fmt][fields][lp_blob] */
#define RDB_TYPE_HASH_TMPL_LP_REF   30        /* Hinted hash (v15): with template ref (RDB save): [tid][lp_blob] */
#define RDB_TYPE_HASH_TMPL_ARRAY    31        /* Hinted hash (v15): self-contained (DUMP): [fields_fmt][fields][v0]...[vN-1] */
#define RDB_TYPE_HASH_TMPL_ARRAY_REF 32       /* Hinted hash (v15): with template ref (RDB save): [tid][v0]...[vN-1] */
#define RDB_TYPE_GCRA               33        /* GCRA object (Redis Ent ENABLE_GCRA only; reserved, not parsed) */
#define RDB_TYPE_MAX                34


/* Highest hinted-hash-template id the registry accepts (v15). The saver assigns
...
#define RDB_HASH_TMPL_MAX_ID  (1<<21) /* 2MB entries */

/* Special RDB opcodes (saved/loaded with rdbSaveType/rdbLoadType). */
#define RDB_OPCODE_HASH_TEMPLATE 242 /* One hinted hash template record (v15). */
...
/* Available only in Redis Ent: */
#define __RDB_OPCODE_RAM_LRU        107 
#define __RDB_OPCODE_SLOT_NUM         121
